...
You are asked to act as reviewer of the article by @waller2021. In your review, you should act *as if* the paper has not yet been published. Your reviews should outline:
...
In a second part, you should consult the data files that I have forked to my Github [here](https://github.com/cjbarrie/social-dimensions-assignment). You are required to reproduce any *two* of the figures in the published article. These do not have to look *exactly the same* as the published versions but they should display the same data in a similar way.
