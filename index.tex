...
{\centering \includegraphics{https://upload.wikimedia.org/wikipedia/commons/1/1b/Ken_Thompson_and_Dennis_Ritchie--1973.jpg}
...
\addcontentsline{toc}{subsection}{Using Git clients}
...
\addcontentsline{toc}{section}{Project-oriented research}
...
\addcontentsline{toc}{subsubsection}{How to organize code in an R
markdown file}
...
\item
  Can you explain why sharing code and data is not enough for
...
\addcontentsline{toc}{section}{Writing code: How to code like a
professional}

\hypertarget{the-bic-piture}{%
\subsection*{The Bic Piture}\label{the-bic-piture}}
\addcontentsline{toc}{subsection}{The Bic Piture}
...
\addcontentsline{toc}{subsection}{Write readable code}
...
\addcontentsline{toc}{subsection}{Asking questions: Minimal reproducible
example}
...
\leavevmode\vadjust pre{\hypertarget{ref-lazer2021}{}}%
